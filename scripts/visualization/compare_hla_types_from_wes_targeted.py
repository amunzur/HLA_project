...
"""
Oncoprint style, compares the concordance of the calls made by polysolver from WES vs targeted data.
...
targeted_types=return_hla_types_for_samples(targeted_samples)
